...
![](p8105_hw5_ss6692_files/figure-gfm/spaghetti_plot-1.png)<!-- -->

### Problem 3

#### Setting up design elements

First, we will calculate p values and mu hat using the provided
specifications. This will be iterated 5000 times.
...
Now, we will calculate the average estimate of mu in samples where the
null was rejected
...
ggplot(true_mu, aes(x = mu_df, y = mean_mu)) +
  ...
  labs(title = "Comparing True μ to the Rejected μ")
```

![](p8105_hw5_ss6692_files/figure-gfm/mu_plot-1.png)<!-- -->
